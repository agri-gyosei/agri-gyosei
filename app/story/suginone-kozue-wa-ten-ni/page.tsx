...
const CHAPTERS = [
  ...
  },
  {
    number: "三月",
    title: "三月",
    excerpt: "季節が変わっても、任務は変わらない。それが当たり前だった。三月が来るまでは。",
  },
  {
    number: "第2章",
    title: "亀裂",
  ...
  },
  {
    number: "五月",
    title: "五月",
    excerpt: "五月の奥多摩。杉の匂い。エレズは初めて、指示書なしに山の中にいた。",
  },
  {
    number: "第3章",
    title: "内側から",
  ...
  },
  {
    number: "二日後",
    title: "二日後",
    excerpt: "二日で変わることがある。二十年かけても変わらないことがある。エレズには、前者だった。",
  },
  {
    number: "第6章",
    title: "三人",
  ...
  },
  {
    number: "三日後",
    title: "三日後",
    excerpt: "三日後に、全てが動く。止める方法は一つだった。エレズには、それができた。",
  },
  {
    number: "第10章",
    title: "放つ",
  ...
  },
  {
    number: "翌朝",
    title: "翌朝",
    excerpt: "翌朝、世界はいつも通りだった。だがエレズには、全てが違って見えた。",
  },
  {
    number: "その頃",
    title: "その頃",
    excerpt: "その頃、東京では。その頃、奥多摩では。その頃、テルアビブでは。",
  },
  {
    number: "同じ頃",
    title: "同じ頃",
    excerpt: "同じ瞬間に、違う場所で、同じことを考えていた人間が、複数いた。",
  },
  {
    number: "第11章",
    title: "波紋",
  ...
  },
  {
    number: "テルアビブ",
    title: "テルアビブ　拘束施設",
    excerpt: "施設の中で、エレズは初めて、外の空気を思い出した。杉の匂いがした。",
  },
  {
    number: "東京",
    title: "東京　エマの部屋",
    excerpt: "エマの部屋に、知らない男の話が届いた。内側から動いた人間がいると。",
  },
  {
    number: "奥多摩",
    title: "奥多摩　透",
    excerpt: "透は山の中で、気配を感じた。新しい根が、静かに張り始めていた。",
  },
  {
    number: "エピローグ",
    title: "杉の木の下で",
